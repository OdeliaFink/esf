...
// Featred Video
$featured_video          = kalium_get_field( 'featured_video' );
$featured_video_autoplay = kalium_get_field( 'featured_video_autoplay' );
$featured_video_mute     = kalium_get_field( 'featured_video_mute' );
$featured_video_controls = kalium_get_field( 'featured_video_controls' );
$featured_video_loop     = kalium_get_field( 'featured_video_loop' );

// Video element
$post_featured_video_element = kalium_render_video_element( $featured_video, [
	'poster'     => $post_thumbnail_id,
	'autoplay'   => $featured_video_autoplay,
	'muted'      => $featured_video_autoplay ? true : $featured_video_mute,
	'controls'   => $featured_video_controls,
	'loop'       => $featured_video_loop,
	'posterplay' => ! $featured_video_autoplay && ! $featured_video_controls,
] );
