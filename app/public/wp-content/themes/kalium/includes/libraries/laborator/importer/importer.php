...
class Kalium_Demo_Content_Importer {
	...
	public function __construct() {
		...
		add_filter( 'wp_redirect', [ $this, '_disable_redirects' ], 100000 );
	}
	...
	/**
	 * Disable redirects when demo content importer is active.
	 */
	public function _disable_redirects( $url ) {
		if ( wp_doing_ajax() && 'kalium_demos_import_actions' === kalium()->request->request( 'action' ) ) {
			return false;
		}
